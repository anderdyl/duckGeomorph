...
% figure
% hist(phiDegrees(:,1),30)
% % plot(phiDegrees(:,1),Rt(:,1),'o')
...
load('ceofsNorthernTransect.mat')


figure
% subplot(211)
plot(time,unwrap(phiDegrees(:,1)*pi/180),'b--')
% subplot(212)
hold on
plot(time,unwrap(phiDegrees(:,2)*pi/180),'b-')

plot(southTime,unwrap(southPhi(:,1)*pi/180),'r--')
plot(southTime,unwrap(southPhi(:,2)*pi/180),'r-')
